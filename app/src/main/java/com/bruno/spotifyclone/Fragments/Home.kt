...
import com.bruno.spotifyclone.Detalhes

import com.bruno.spotifyclone.R
import com.bruno.spotifyclone.databinding.AlbumItemBinding
import com.bruno.spotifyclone.databinding.CategoriaItemBinding
import com.bruno.spotifyclone.databinding.FragmentHomeBinding
import com.bruno.spotifyclone.model.*
...
class Home : Fragment() {
    ...
    private inner class CategoriaAdapter(internal val categorias: MutableList<Categoria>): RecyclerView.Adapter<CategoriaHolder>() {
        ...
        //ViewBinding na CategoriaAdapter
    ...
    private inner class CategoriaHolder(binding: CategoriaItemBinding): RecyclerView.ViewHolder(binding.root){
        ...
        private val recycler_albuns = binding.recyclerAlbuns
         ...
         fun bind(categoria: Categoria){
             ...
             recycler_albuns.layoutManager = LinearLayoutManager(context,RecyclerView.HORIZONTAL,false)
    ...
    private inner class AlbunsHolder(binding: AlbumItemBinding, val onClick: ((Album) -> Unit)?): RecyclerView.ViewHolder(binding.root){

        private val image_album = binding.imageAlbum

        fun bind(album: Album){
           Picasso.get().load(album.album).placeholder(R.drawable.placeholder).fit().into(image_album)
